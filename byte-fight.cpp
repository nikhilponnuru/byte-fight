//https://msdn.microsoft.com/en-in/library/windows/desktop/ff818516(v=vs.85).aspx
#include<iostream.h>
#include<stdio.h>
#include<windows.h>
#include<time.h>
...
void score(int uhealth,int chealth,int ubullets,int uboomerang,int uwall,int boost,int nofboost)    
{
    HANDLE out;
    out=GetStdHandle(STD_OUTPUT_HANDLE);
